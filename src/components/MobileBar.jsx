    ...
    <aside aria-label="Acciones rápidas de contacto" className="mobile-sticky-bar">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        <a 
          ...
          style={{ padding: '0.5rem 0.85rem', fontSize: '11px', fontWeight: 'bold', textTransform: 'uppercase' }}
        >
          WhatsApp
        </a>
        <button 
          onClick={onOpenPassModal} 
          className="btn-neon neon-glow-sm"
          style={{ padding: '0.55rem 1rem', fontSize: '12px' }}
          type="button"
        >
          Pase Gratis
        </button>
