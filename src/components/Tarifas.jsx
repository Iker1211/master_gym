      ...
      <div className="container">
        ...
        <div className="pricing-grid">
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.25rem' }}>
                <div>
                  ...
                  <h3 className="font-display text-white" style={{ fontSize: '2rem', textTransform: 'uppercase', marginTop: '0.25rem' }}>
                    Pase Diario
                  </h3>
                </div>
                <span style={{ fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 'bold', padding: '0.2rem 0.5rem', background: 'rgba(255,255,255,0.1)', color: '#FFF' }}>
                  Por Día
                </span>
              </div>

              <p style={{ fontSize: '12px', color: 'var(--color-muted)', marginBottom: '1.5rem' }}>
                Ideal para entrenamientos sueltos, probar el gym o si estás de paso en Manta. Paga solo cuando vienes.
              </p>

              {/* Price Display */}
              <div className="price-display">
                <span className="price-amount">$1<span style={{ fontSize: '1.5rem', color: 'var(--color-muted)' }}>.50</span></span>
              ...
              <ul className="benefits-list">
                <li>
                  <span className="text-neon" style={{ fontWeight: 'bold' }}>—</span>
                ...
                <li style={{ color: 'var(--color-muted)', textDecoration: 'line-through' }}>
                  <span>—</span>
          ...
          <div className="pricing-card">
            <div>
              ...
              {/* Price Display */}
              <div className="price-display">
                <span className="price-amount">$5<span style={{ fontSize: '1.5rem', color: 'var(--color-muted)' }}>.00</span></span>
          ...
          {/* ================= Plan 3: Mes Completo (FEATURED NEÓN) ================= */}
          <div className="pricing-card featured neon-glow">
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem', paddingTop: '0.5rem' }}>
                <div>
                  <span className="text-neon font-mono" style={{ fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 'bold' }}>
                    Membresía Mensual
                  </span>
                  <h3 className="font-display text-white" style={{ fontSize: '2.35rem', textTransform: 'uppercase', marginTop: '0.25rem' }}>
                    Mes Completo
                  </h3>
                </div>
              </div>

              <p style={{ fontSize: '12px', color: 'rgba(244, 244, 246, 0.9)', marginBottom: '1rem' }}>
              ...
              <div className="price-display" style={{ marginBottom: '1rem', paddingBottom: '0.75rem' }}>
                <span className="price-amount">$20<span style={{ fontSize: '1.5rem', color: 'var(--color-cyber-yellow)' }}>.00</span></span>
              ...
              <div className="promo-callout">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.25rem' }}>
                  <span style={{ fontSize: '10px', fontWeight: '900', textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--color-cyber-yellow)' }}>
                    PROMO ACOMPAÑANTE
                  </span>
                  <span className="font-mono text-white" style={{ fontSize: '11px', fontWeight: 'bold', background: 'rgba(255, 234, 0, 0.2)', padding: '0.15rem 0.5rem', border: '1px solid rgba(255,234,0,0.4)', color: 'var(--color-cyber-yellow)' }}>
                    $15 c/u
                  </span>
                </div>
                <p style={{ fontSize: '11px', color: 'var(--color-light)', lineHeight: '1.4' }}>
                  ¡Si vienes con un acompañante (amigo o pareja), <strong style={{ color: 'var(--color-cyber-yellow)' }}>pagan solo $15 al mes cada uno</strong> ($30 en total por los dos)!
                </p>
              </div>
              ...
              <ul className="benefits-list">
                <li>
                  <span className="text-pink" style={{ fontWeight: 'bold' }}>—</span>
                ...
                <li>
                  <span className="text-yellow" style={{ fontWeight: 'bold' }}>—</span>
                  <span><strong style={{ color: 'var(--color-cyber-yellow)' }}>Aplica promo $15 c/u</strong> con acompañante</span>
                </li>
              </ul>
            </div>
        ...
        <div className="payment-methods-bar">
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <span style={{ width: '10px', height: '10px', backgroundColor: 'var(--color-neon)', display: 'inline-block' }}></span>
          ...
          <button onClick={onOpenPassModal} className="text-neon" style={{ background: 'none', border: 'none', cursor: 'pointer', fontWeight: 'bold', textTransform: 'uppercase', textDecoration: 'underline', font: 'inherit', whiteSpace: 'nowrap' }}>
